...
public class StudentOrderDaoImplTest {
    //нужно добавить студенческую семью и получить список студенческих заявок
    ...
    public void saveStudentOrder() throws DaoException {
        ...
        Long id = new StudentOrderDaoImpl().saveStudentOrder(so);//создаем данные в заявку
    }

    /* //первый вариант ожидания ошибки
        @Test
    ...
    //второй вариант ожидания ошибки
    @Test(expected = DaoException.class)//если выскочит этаошибка, то тест корректный
    ...
    public void getStudentOrders() throws DaoException {
        List<StudentOrder> list = new StudentOrderDaoImpl().getStudentOrders();//получаем список студ заявок
    }
